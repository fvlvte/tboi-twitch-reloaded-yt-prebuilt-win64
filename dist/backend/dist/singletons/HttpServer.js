...
class HttpServer {
    ...
    async handleYoutubeInit(req, res) {
        try {
            ...
            const page = await _1.BrowserManager.getInstance().spawnBlankPage();
            new _1.YoutubeLajtScraper(page).initOnYoutubeLajt(req.query.ytId);
    ...
    async init(port) {
        ...
        this.app.use("/frontend", express_1.default.static(process.env.NODE_ENV === "production"
            ? "dist/frontend"
            : "../frontendPrebuilt", { index: "index.html" }));
